...
from gitlab.analyzer import sync_repo, sync_commits, get_student_stats, get_all_student_stats
from gitlab.client import get_project
from db import DbCursor

gitlab_bp = Blueprint("gitlab", __name__, url_prefix="/gitlab")


@gitlab_bp.route("/repos", methods=["POST"])
@require_auth
...
@gitlab_bp.route("/repos/<int:repo_db_id>/sync", methods=["POST"])
@require_auth
@require_role("instructor", "ta")
...
@gitlab_bp.route("/repos/<int:repo_db_id>/stats", methods=["GET"])
@require_auth
...
@gitlab_bp.route("/repos/<int:repo_db_id>/commits", methods=["GET"])
@require_auth
